...
public class PostImporting : AssetPostprocessor
{
    ...
    static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
    {
        ...
        //{
        //    EditorApplication.OpenScene("Assets/Dragons/Scenes/game.unity");
        //    EditorApplication.ExecuteMenuItem("Window/Jelly Garder editor");
        //    if (AssetDatabase.IsValidFolder("Assets/Dragons/Facebook"))
        //    {
        //        AssetDatabase.DeleteAsset("Assets/Dragons/Facebook");
        //        AssetDatabase.DeleteAsset("Assets/Plugins/Android/facebook");
        //    }
        //    AssetDatabase.MoveAsset("Assets/Dragons/Plugins", "Assets/Plugins");
        //    AssetDatabase.MoveAsset("Assets/Dragons/FacebookSDK", "Assets/FacebookSDK");
